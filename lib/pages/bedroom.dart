...
import 'package:internassignment/utilties/Colorslider.dart';
import 'package:internassignment/utilties/Scenes.dart';
import 'package:internassignment/utilties/slider.dart';

class Bedroom extends StatefulWidget {
  final String lights;

  const Bedroom({Key key, this.lights}) : super(key: key);
    ...
    return Scaffold(
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                icon: SvgPicture.asset("Assets/Iconfeather-home.svg"),
                label: ""),
            BottomNavigationBarItem(
        ...
        body: Stack(children: [
          ...
          Positioned(
            ...
            child: Container(
                ...
                child: SvgPicture.asset("Assets/poweroff.svg")),
          ),
        ]));
  }
}
